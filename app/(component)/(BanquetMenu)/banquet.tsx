...
const Banquet = () => {
  ...
  return (
    ...
    >
      ...
      <ul className="lg:p-8 p-5 bg-gradient-to-tr from-pink-200 to-blue-300 border-2 border-black shadow-[0.25rem_0.25rem_0px_0px_rgba(0,0,0,1)] rounded lg:mb-10 mb-8 lg:mt-5 mt-3">
        {banquetMenu.map((item: any) => (
          <li key={item.id}>
            <p className="p-2 text-black font-unbounded text-lg font-medium capitalize">
              {item.name}
            </p>
